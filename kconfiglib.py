...
class Kconfig(object):
    ...
    def _parse_properties(self, node):
        # Parses properties on menu nodes
        #
        # !!! yada yada
        #
        # node:
    ...
    def _finalize_tree(self, node, visible_if):
        ...
        # removes 'if' nodes, and finalizes choices. This pretty closely
        # mirrors menu_finalize() from the C implementation, though we
        # propagate dependencies during parsing instead.
        ...
        if node.list:
            ...
            # individually finalized. Do final steps to finalize this "level"
            # in the menu tree.
            _flatten(node.list)
            _remove_ifs(node)
...
class MenuNode(object):
    ...
    def __str__(self):
        ...
        return self._sym_choice_node_str()
